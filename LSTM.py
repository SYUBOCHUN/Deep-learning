...
testing_dataframe = pandas.read_csv(r"C:\data\dengue\normalization\2016\tpshilin2016.csv", header=None) #testing_dataset
...
# RNN cell
    model.add(LSTM(batch_input_shape=(None, 1, 5), units=128,
...
estimator = KerasClassifier(build_fn=baseline_model, epochs=2000, batch_size=100, verbose=2)
